...
public class Logger
{
    ...
    {
        BuildEngine.LogWarningEvent(new BuildWarningEventArgs("", "", "", 0, 0, 0, 0, string.Format("{0}: {1}", "Costura", message), "", "Costura"));
    }
    ...
    public virtual void LogError(string message)
    {
        ...
        BuildEngine.LogErrorEvent(new BuildErrorEventArgs("", "", "", 0, 0, 0, 0, string.Format("{0}: {1}", "Costura", message), "", "Costura"));
    }
